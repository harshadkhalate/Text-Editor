...
public class TextEditor {
  ...
  private void initialize() {
    ...
    frmTextEditor.setBounds(200, 200, 1000, 610);
...
frmTextEditor.getContentPane().setLayout(new BorderLayout(0, 0));
    ...
    JLabel lblThisEditorIs = new JLabel("Text Editor is designed in Java");
    mnInfo.add(lblThisEditorIs);
    
    JSeparator separator = new JSeparator();
    mnInfo.add(separator);
    
    JLabel lblDevelopedByHarshad = new JLabel("& Developed By Harshad Khalate");
    mnInfo.add(lblDevelopedByHarshad);    
